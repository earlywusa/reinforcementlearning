...
#     # Value Iteration
    ...
    if (value_iteration):
        ...
        for nIter in iterations:
            startTime = clock()
            vi = ValueIteration(domain,rf,tf,discount,hashingFactory,0, nIter); #//Added a very high delta number in order to guarantee that value iteration occurs the max number of iterations for comparison with the other algorithms.
            ...
            if(nIter == 1 or nIter == 2 or nIter == 5 or nIter == 10 or nIter == 15 or vi.latestDelta < 0.000001):
                simpleValueFunctionVis(vi, p, initialState, domain, hashingFactory, "Value Iteration {}".format(nIter))
                print "rewards:"
                print rewards
                print "steps:"
    ...
    if(policy_iteration):  
        ...
        for nIter in iterations:
            ...
            if(nIter == 1 or nIter == 2 or nIter == 5 or nIter == 10 or nIter == 15 or nIter == 35):
                simpleValueFunctionVis(pi, p, initialState, domain, hashingFactory, "Policy Iteration{}".format(nIter))
                print "rewards:"
                print rewards
                print "steps:"
